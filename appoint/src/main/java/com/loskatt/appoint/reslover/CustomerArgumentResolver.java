package com.loskatt.appoint.reslover;
...
import com.loskatt.appoint.aop.ParameterModel;
        ...
        while(iterator.hasNext())
        {
            ...
            try {
                 ...
                 */
                	...
                	if(int.class.isAssignableFrom(fieldTargetType)||Integer.class.isAssignableFrom(fieldTargetType)){
                    	field.set(object, Integer.valueOf(parameterValue[0]));
                    }else if(Long.class.isAssignableFrom(fieldTargetType)||long.class.isAssignableFrom(fieldTargetType)){
                    	field.set(object, Long.valueOf(parameterValue[0]));
                    }else if(Double.class.isAssignableFrom(fieldTargetType)||double.class.isAssignableFrom(fieldTargetType)){
                    	field.set(object, Double.valueOf(parameterValue[0]));
                    }else if(Float.class.isAssignableFrom(fieldTargetType)||float.class.isAssignableFrom(fieldTargetType)){
                    	field.set(object, Float.valueOf(parameterValue[0]));
                    }else if(Boolean.class.isAssignableFrom(fieldTargetType)||boolean.class.isAssignableFrom(fieldTargetType)){
                    	field.set(object, Boolean.valueOf(parameterValue[0]));
                    }else if(Date.class.isAssignableFrom(fieldTargetType)){
                    	SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
                    	field.set(object, sf.parse(parameterValue[0]));
                    }else{
